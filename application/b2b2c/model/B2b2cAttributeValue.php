...
{
    protected $name = 'b2b2c_attribute_value';// 设置当前模型对应的完整数据表名称

    protected static $cacheName = 'b2b2c_attribute_value'; // 缓存名称

    /**
     * 获取所有属性值数据(取缓存)
     * @author 仇仇天
     */
    public static function getAttributeValueDataInfo()
    {
