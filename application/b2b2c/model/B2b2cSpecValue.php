 ...
 */
class B2b2cSpecValue extends Model
{
    protected $name = 'b2b2c_spec_value';// 设置当前模型对应的完整数据表名称

    protected static $cacheName = 'b2b2c_spec_value'; // 缓存名称

    /**
     * 获取所有规格值数据(取缓存)
     * @author 仇仇天
     */
    public static function getSpecValueDataInfo()
    {
