 ...
 */
class B2b2cTypeSpec extends Model
{
    protected $name = 'b2b2c_type_spec';// 设置当前模型对应的完整数据表名称

    protected static $cacheName = 'b2b2c_type_spec'; // 缓存名称

    /**
     * 获取所有类型关联规格数据(取缓存)
     * @author 仇仇天
     */
    public static function getTypeSpecDataInfo()
    {
