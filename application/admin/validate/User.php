...
class User extends Validate
{
    ...
    protected $scene = [
        ...
        //用户名
        'username' => ['username' => 'require|alphaNum|unique:admin_user'],
        //昵称
        'nickname' => ['nickname' => 'require|unique:admin_user'],
        //手机号
        'mobile'   => ['mobile' => 'regex:^1\d{10}|unique:admin_user'],
        //邮箱
        'email'    => ['email' => 'email|unique:admin_user'],
    ];
}
