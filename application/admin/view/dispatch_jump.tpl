...
<div class="row">
    <div class="col-md-12 page-500">
        ...
        <div class=" details">
            ...
            <p>
                <a class="btn green btn-outline" href="<?php echo($url);?>"><i class="fa fa-external-link-square"></i>
                    立即跳转</a>
                <button class="btn yellow btn-outline" type="button" onclick="stop()"><i class="fa fa-ban"></i> 禁止跳转
                </button>
...
<script src="__GLODAL_PLUGINS__/bootstrap/js/bootstrap.min.js?v={:config('asset_version')}"
        type="text/javascript"></script>
<script src="__GLODAL_PLUGINS__/js.cookie.min.js?v={:config('asset_version')}" type="text/javascript"></script>
<script src="__GLODAL_PLUGINS__/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js?v={:config('asset_version')}"
        type="text/javascript"></script>
<script src="__GLODAL_PLUGINS__/jquery-slimscroll/jquery.slimscroll.min.js?v={:config('asset_version')}"
        type="text/javascript"></script>
<script src="__GLODAL_PLUGINS__/jquery.blockui.min.js?v={:config('asset_version')}" type="text/javascript"></script>
<script src="__GLODAL_PLUGINS__/uniform/jquery.uniform.min.js?v={:config('asset_version')}"
        type="text/javascript"></script>
<script src="__GLODAL_PLUGINS__/bootstrap-switch/js/bootstrap-switch.min.js?v={:config('asset_version')}"
        type="text/javascript"></script>
