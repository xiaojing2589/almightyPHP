...
-- ----------------------------
INSERT INTO `dp_admin_config` VALUES ('1', 'web_site_status', '站点开关', 'base', 'switch', '1', '', '站点关闭后将不能访问，后台可正常登录', '', '', '', '', '', '2', '', '', '', '', '1475240395', '1556900153', '1', '1');
...
INSERT INTO `dp_admin_config` VALUES ('3', 'web_site_slogan', '站点标语', 'base', 'text', '极简、极速、极致', '', '站点口号，调用方式：<code>config(\'web_site_slogan\')</code>', '', '', '', '', '', '2', '', '', '', '', '1475240994', '1477710357', '3', '1');
...
INSERT INTO `dp_admin_config` VALUES ('17', 'system_color', '后台配色方案', 'system', 'radio', 'amethyst', 'default:Default\r\namethyst:Amethyst\r\ncity:City\r\nflat:Flat\r\nmodern:Modern\r\nsmooth:Smooth', '', '', '', '', '', '', '2', '', '', '', '', '1475250066', '1477316689', '102', '1');
...
INSERT INTO `dp_admin_config` VALUES ('34', 'captcha_signin', '后台验证码开关', 'system', 'switch', '1', '', '后台登录时是否需要验证码', '', '', '', '', '', '2', '', '', '', '', '1478771958', '1478771958', '99', '1');
...
) ENGINE=MyISAM AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';

-- ----------------------------
-- Records of dp_admin_log
-- ----------------------------
INSERT INTO `dp_admin_log` VALUES ('1', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(system)', '1', '1555682951');
INSERT INTO `dp_admin_log` VALUES ('2', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(develop)', '1', '1555807545');
INSERT INTO `dp_admin_log` VALUES ('3', '16', '1', '2130706433', 'admin_config', '1', '超级管理员1 编辑了配置：原数据：分组(base)、类型(switch)、标题(站点开关)、名称(web_site_status)', '1', '1555815261');
INSERT INTO `dp_admin_log` VALUES ('4', '16', '1', '2130706433', 'admin_config', '1', '超级管理员1 编辑了配置：原数据：分组(base)、类型(switch)、标题(站点开关1)、名称(web_site_status)', '1', '1555815287');
INSERT INTO `dp_admin_log` VALUES ('5', '16', '1', '2130706433', 'admin_config', '1', '超级管理员1 编辑了配置：原数据：分组(base)、类型(switch)、标题(站点开关1)、名称(web_site_status)', '1', '1555815316');
INSERT INTO `dp_admin_log` VALUES ('6', '31', '1', '2130706433', 'admin_menu', '1', '超级管理员 编辑了节点：节点ID(1)', '1', '1555815341');
INSERT INTO `dp_admin_log` VALUES ('7', '31', '1', '2130706433', 'admin_menu', '1', '超级管理员 编辑了节点：节点ID(1)', '1', '1555815350');
INSERT INTO `dp_admin_log` VALUES ('8', '31', '1', '2130706433', 'admin_menu', '1', '超级管理员 编辑了节点：节点ID(1)', '1', '1555815381');
INSERT INTO `dp_admin_log` VALUES ('9', '31', '1', '2130706433', 'admin_menu', '1', '超级管理员 编辑了节点：节点ID(1)', '1', '1555815412');
INSERT INTO `dp_admin_log` VALUES ('10', '31', '1', '2130706433', 'admin_menu', '1', '超级管理员 编辑了节点：节点ID(1)', '1', '1555815571');
INSERT INTO `dp_admin_log` VALUES ('11', '31', '1', '2130706433', 'admin_menu', '1', '超级管理员 编辑了节点：节点ID(1)', '1', '1555816129');
INSERT INTO `dp_admin_log` VALUES ('12', '30', '1', '2130706433', 'admin_menu', '236', '超级管理员 添加了节点：所属模块(admin),所属节点ID(4),节点标题(后台用户),节点链接(admin/user/index)', '1', '1555844071');
INSERT INTO `dp_admin_log` VALUES ('13', '31', '1', '2130706433', 'admin_menu', '236', '超级管理员 编辑了节点：节点ID(236)', '1', '1555844150');
INSERT INTO `dp_admin_log` VALUES ('14', '31', '1', '2130706433', 'admin_menu', '236', '超级管理员 编辑了节点：节点ID(236)', '1', '1555844204');
INSERT INTO `dp_admin_log` VALUES ('15', '30', '1', '2130706433', 'admin_menu', '237', '超级管理员 添加了节点：所属模块(admin),所属节点ID(236),节点标题(用户管理),节点链接(admin/user/index)', '1', '1555844251');
INSERT INTO `dp_admin_log` VALUES ('16', '30', '1', '2130706433', 'admin_menu', '238', '超级管理员 添加了节点：所属模块(admin),所属节点ID(236),节点标题(角色管理),节点链接(admin/role/index)', '1', '1555844752');
INSERT INTO `dp_admin_log` VALUES ('17', '34', '1', '2130706433', 'admin_menu', '236', '超级管理员 禁用了节点：节点ID(236),节点标题(后台用户),节点链接()', '1', '1555844913');
INSERT INTO `dp_admin_log` VALUES ('18', '33', '1', '2130706433', 'admin_menu', '236', '超级管理员 启用了节点：节点ID(236),节点标题(后台用户),节点链接()', '1', '1555844916');
INSERT INTO `dp_admin_log` VALUES ('19', '30', '1', '2130706433', 'admin_menu', '239', '超级管理员 添加了节点：所属模块(admin),所属节点ID(236),节点标题(消息),节点链接(admin/usermessage/index)', '1', '1555844964');
INSERT INTO `dp_admin_log` VALUES ('20', '30', '1', '2130706433', 'admin_menu', '240', '超级管理员 添加了节点：所属模块(admin),所属节点ID(237),节点标题(权限管理),节点链接()', '1', '1556895955');
INSERT INTO `dp_admin_log` VALUES ('21', '30', '1', '2130706433', 'admin_menu', '241', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(新增),节点链接(admin/user/add)', '1', '1556896061');
INSERT INTO `dp_admin_log` VALUES ('22', '30', '1', '2130706433', 'admin_menu', '242', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(编辑),节点链接(admin/user/edit)', '1', '1556896128');
INSERT INTO `dp_admin_log` VALUES ('23', '30', '1', '2130706433', 'admin_menu', '243', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(删除),节点链接(amdin/user/delete)', '1', '1556896162');
INSERT INTO `dp_admin_log` VALUES ('24', '30', '1', '2130706433', 'admin_menu', '244', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(启用),节点链接(admin/role/enable)', '1', '1556896266');
INSERT INTO `dp_admin_log` VALUES ('25', '30', '1', '2130706433', 'admin_menu', '245', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(禁用),节点链接(admin/role/disable)', '1', '1556896309');
INSERT INTO `dp_admin_log` VALUES ('26', '30', '1', '2130706433', 'admin_menu', '246', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(快速编辑),节点链接(admin/role/quickedit)', '1', '1556896421');
INSERT INTO `dp_admin_log` VALUES ('27', '31', '1', '2130706433', 'admin_menu', '244', '超级管理员 编辑了节点：节点ID(244)', '1', '1556896470');
INSERT INTO `dp_admin_log` VALUES ('28', '31', '1', '2130706433', 'admin_menu', '245', '超级管理员 编辑了节点：节点ID(245)', '1', '1556896522');
INSERT INTO `dp_admin_log` VALUES ('29', '31', '1', '2130706433', 'admin_menu', '246', '超级管理员 编辑了节点：节点ID(246)', '1', '1556896542');
INSERT INTO `dp_admin_log` VALUES ('30', '30', '1', '2130706433', 'admin_menu', '247', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(启用),节点链接(admin/user/enable)', '1', '1556896621');
INSERT INTO `dp_admin_log` VALUES ('31', '30', '1', '2130706433', 'admin_menu', '248', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(禁用),节点链接(admin/user/disable)', '1', '1556896658');
INSERT INTO `dp_admin_log` VALUES ('32', '30', '1', '2130706433', 'admin_menu', '249', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(授权),节点链接(admin/user/access)', '1', '1556896721');
INSERT INTO `dp_admin_log` VALUES ('33', '31', '1', '2130706433', 'admin_menu', '248', '超级管理员 编辑了节点：节点ID(248)', '1', '1556896752');
INSERT INTO `dp_admin_log` VALUES ('34', '31', '1', '2130706433', 'admin_menu', '249', '超级管理员 编辑了节点：节点ID(249)', '1', '1556896769');
INSERT INTO `dp_admin_log` VALUES ('35', '30', '1', '2130706433', 'admin_menu', '250', '超级管理员 添加了节点：所属模块(admin),所属节点ID(240),节点标题(快速编辑),节点链接(admin/user/quickedit)', '1', '1556896812');
INSERT INTO `dp_admin_log` VALUES ('36', '30', '1', '2130706433', 'admin_menu', '251', '超级管理员 添加了节点：所属模块(admin),所属节点ID(238),节点标题(新增),节点链接(admin/role/add)', '1', '1556896840');
INSERT INTO `dp_admin_log` VALUES ('37', '30', '1', '2130706433', 'admin_menu', '252', '超级管理员 添加了节点：所属模块(admin),所属节点ID(238),节点标题(编辑),节点链接(admin/role/edit)', '1', '1556896864');
INSERT INTO `dp_admin_log` VALUES ('38', '30', '1', '2130706433', 'admin_menu', '253', '超级管理员 添加了节点：所属模块(admin),所属节点ID(238),节点标题(删除),节点链接(admin/role/delete)', '1', '1556896892');
INSERT INTO `dp_admin_log` VALUES ('39', '22', '1', '2130706433', 'database', '0', '超级管理员 优化了数据表：`dp_admin_access`,`dp_admin_action`,`dp_admin_attachment`,`dp_admin_config`,`dp_admin_hook`,`dp_admin_hook_plugin`,`dp_admin_icon`,`dp_admin_icon_list`,`dp_admin_log`,`dp_admin_menu`,`dp_admin_message`,`dp_admin_module`,`dp_admin_packet`,`dp_admin_plugin`,`dp_admin_role`,`dp_admin_user`', '1', '1556897287');
INSERT INTO `dp_admin_log` VALUES ('40', '32', '1', '2130706433', 'admin_menu', '239', '超级管理员 删除了节点：节点ID(239),节点标题(消息),节点链接(admin/usermessage/index)', '1', '1556897394');
INSERT INTO `dp_admin_log` VALUES ('41', '16', '1', '2130706433', 'admin_config', '1', '超级管理员 编辑了配置：原数据：分组(base)、类型(switch)、标题(站点开关1)、名称(web_site_status)', '1', '1556900152');
INSERT INTO `dp_admin_log` VALUES ('42', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(develop)', '1', '1557159968');
INSERT INTO `dp_admin_log` VALUES ('43', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(develop)', '1', '1557237541');
INSERT INTO `dp_admin_log` VALUES ('44', '22', '1', '2130706433', 'database', '0', '超级管理员 优化了数据表：dp_admin_access', '1', '1557245122');
INSERT INTO `dp_admin_log` VALUES ('45', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(base)', '1', '1557278067');
INSERT INTO `dp_admin_log` VALUES ('46', '23', '1', '2130706433', 'database', '0', '超级管理员 修复了数据表：`dp_admin_access`,`dp_admin_action`,`dp_admin_attachment`,`dp_admin_config`,`dp_admin_hook`,`dp_admin_hook_plugin`,`dp_admin_icon`,`dp_admin_icon_list`,`dp_admin_log`,`dp_admin_menu`,`dp_admin_message`,`dp_admin_module`,`dp_admin_packet`,`dp_admin_plugin`,`dp_admin_role`,`dp_admin_user`', '1', '1557362020');
INSERT INTO `dp_admin_log` VALUES ('47', '31', '1', '2130706433', 'admin_menu', '3', '超级管理员 编辑了节点：节点ID(3)', '1', '1557630826');
INSERT INTO `dp_admin_log` VALUES ('48', '32', '1', '2130706433', 'admin_menu', '222', '超级管理员 删除了节点：节点ID(222),节点标题(消息中心),节点链接(admin/message/index)', '1', '1557630855');
INSERT INTO `dp_admin_log` VALUES ('49', '30', '1', '2130706433', 'admin_menu', '254', '超级管理员 添加了节点：所属模块(admin),所属节点ID(2),节点标题(个人设置),节点链接(admin/index/profile)', '1', '1557630970');
INSERT INTO `dp_admin_log` VALUES ('50', '32', '1', '2130706433', 'admin_menu', '212', '超级管理员 删除了节点：节点ID(212),节点标题(个人设置),节点链接(admin/index/profile)', '1', '1557631269');
INSERT INTO `dp_admin_log` VALUES ('51', '32', '1', '2130706433', 'admin_menu', '3', '超级管理员 删除了节点：节点ID(3),节点标题(清空缓存),节点链接(admin/index/wipecache)', '1', '1557631426');
INSERT INTO `dp_admin_log` VALUES ('52', '34', '1', '2130706433', 'admin_menu', '1', '超级管理员 禁用了节点：节点ID(1),节点标题(首页),节点链接(admin/index/index)', '1', '1557631716');
INSERT INTO `dp_admin_log` VALUES ('53', '33', '1', '2130706433', 'admin_menu', '1', '超级管理员 启用了节点：节点ID(1),节点标题(首页),节点链接(admin/index/index)', '1', '1557631723');
INSERT INTO `dp_admin_log` VALUES ('54', '34', '1', '2130706433', 'admin_menu', '70', '超级管理员 禁用了节点：节点ID(70),节点标题(后台首页),节点链接(admin/index/index)', '1', '1557631814');
INSERT INTO `dp_admin_log` VALUES ('55', '32', '1', '2130706433', 'admin_menu', '70', '超级管理员 删除了节点：节点ID(70),节点标题(后台首页),节点链接(admin/index/index)', '1', '1557631817');
INSERT INTO `dp_admin_log` VALUES ('56', '32', '1', '2130706433', 'admin_menu', '254', '超级管理员 删除了节点：节点ID(254),节点标题(个人设置),节点链接(admin/index/profile)', '1', '1557631835');
INSERT INTO `dp_admin_log` VALUES ('57', '31', '1', '2130706433', 'admin_menu', '2', '超级管理员 编辑了节点：节点ID(2)', '1', '1557631868');
INSERT INTO `dp_admin_log` VALUES ('58', '31', '1', '2130706433', 'admin_menu', '2', '超级管理员 编辑了节点：节点ID(2)', '1', '1557631910');
INSERT INTO `dp_admin_log` VALUES ('59', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(system)', '1', '1557677479');
INSERT INTO `dp_admin_log` VALUES ('60', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(base)', '1', '1558891818');
INSERT INTO `dp_admin_log` VALUES ('61', '42', '1', '2130706433', 'admin_config', '0', '超级管理员 更新了系统设置：分组(base)', '1', '1558891829');
INSERT INTO `dp_admin_log` VALUES ('62', '32', '1', '2130706433', 'admin_menu', '221', '超级管理员 删除了节点：节点ID(221),节点标题(快速编辑),节点链接(user/message/quickedit)', '1', '1558915516');
INSERT INTO `dp_admin_log` VALUES ('63', '32', '1', '2130706433', 'admin_menu', '220', '超级管理员 删除了节点：节点ID(220),节点标题(禁用),节点链接(user/message/disable)', '1', '1558915522');
INSERT INTO `dp_admin_log` VALUES ('64', '32', '1', '2130706433', 'admin_menu', '219', '超级管理员 删除了节点：节点ID(219),节点标题(启用),节点链接(user/message/enable)', '1', '1558915527');
INSERT INTO `dp_admin_log` VALUES ('65', '32', '1', '2130706433', 'admin_menu', '218', '超级管理员 删除了节点：节点ID(218),节点标题(删除),节点链接(user/message/delete)', '1', '1558915533');
INSERT INTO `dp_admin_log` VALUES ('66', '32', '1', '2130706433', 'admin_menu', '217', '超级管理员 删除了节点：节点ID(217),节点标题(编辑),节点链接(user/message/edit)', '1', '1558915539');
INSERT INTO `dp_admin_log` VALUES ('67', '32', '1', '2130706433', 'admin_menu', '216', '超级管理员 删除了节点：节点ID(216),节点标题(新增),节点链接(user/message/add)', '1', '1558915545');
INSERT INTO `dp_admin_log` VALUES ('68', '32', '1', '2130706433', 'admin_menu', '215', '超级管理员 删除了节点：节点ID(215),节点标题(消息列表),节点链接(user/message/index)', '1', '1558915551');
INSERT INTO `dp_admin_log` VALUES ('69', '32', '1', '2130706433', 'admin_menu', '214', '超级管理员 删除了节点：节点ID(214),节点标题(消息管理),节点链接()', '1', '1558915557');
INSERT INTO `dp_admin_log` VALUES ('70', '32', '1', '2130706433', 'admin_menu', '235', '超级管理员 删除了节点：节点ID(235),节点标题(快速编辑),节点链接(user/role/quickedit)', '1', '1558915633');
INSERT INTO `dp_admin_log` VALUES ('71', '32', '1', '2130706433', 'admin_menu', '75', '超级管理员 删除了节点：节点ID(75),节点标题(禁用),节点链接(user/role/disable)', '1', '1558915637');
INSERT INTO `dp_admin_log` VALUES ('72', '32', '1', '2130706433', 'admin_menu', '74', '超级管理员 删除了节点：节点ID(74),节点标题(启用),节点链接(user/role/enable)', '1', '1558915641');
INSERT INTO `dp_admin_log` VALUES ('73', '34', '1', '2130706433', 'admin_menu', '73', '超级管理员 禁用了节点：节点ID(73),节点标题(删除),节点链接(user/role/delete)', '1', '1558915644');
INSERT INTO `dp_admin_log` VALUES ('74', '33', '1', '2130706433', 'admin_menu', '73', '超级管理员 启用了节点：节点ID(73),节点标题(删除),节点链接(user/role/delete)', '1', '1558915646');
INSERT INTO `dp_admin_log` VALUES ('75', '32', '1', '2130706433', 'admin_menu', '73', '超级管理员 删除了节点：节点ID(73),节点标题(删除),节点链接(user/role/delete)', '1', '1558915647');
INSERT INTO `dp_admin_log` VALUES ('76', '32', '1', '2130706433', 'admin_menu', '72', '超级管理员 删除了节点：节点ID(72),节点标题(编辑),节点链接(user/role/edit)', '1', '1558915651');
INSERT INTO `dp_admin_log` VALUES ('77', '32', '1', '2130706433', 'admin_menu', '71', '超级管理员 删除了节点：节点ID(71),节点标题(新增),节点链接(user/role/add)', '1', '1558915655');
INSERT INTO `dp_admin_log` VALUES ('78', '32', '1', '2130706433', 'admin_menu', '67', '超级管理员 删除了节点：节点ID(67),节点标题(角色管理),节点链接(user/role/index)', '1', '1558915659');
INSERT INTO `dp_admin_log` VALUES ('79', '32', '1', '2130706433', 'admin_menu', '234', '超级管理员 删除了节点：节点ID(234),节点标题(快速编辑),节点链接(user/index/quickedit)', '1', '1558915662');
INSERT INTO `dp_admin_log` VALUES ('80', '32', '1', '2130706433', 'admin_menu', '76', '超级管理员 删除了节点：节点ID(76),节点标题(授权),节点链接(user/index/access)', '1', '1558915666');
INSERT INTO `dp_admin_log` VALUES ('81', '32', '1', '2130706433', 'admin_menu', '25', '超级管理员 删除了节点：节点ID(25),节点标题(禁用),节点链接(user/index/disable)', '1', '1558959880');
INSERT INTO `dp_admin_log` VALUES ('82', '32', '1', '2130706433', 'admin_menu', '24', '超级管理员 删除了节点：节点ID(24),节点标题(启用),节点链接(user/index/enable)', '1', '1558959886');
INSERT INTO `dp_admin_log` VALUES ('83', '32', '1', '2130706433', 'admin_menu', '23', '超级管理员 删除了节点：节点ID(23),节点标题(删除),节点链接(user/index/delete)', '1', '1558959891');
INSERT INTO `dp_admin_log` VALUES ('84', '32', '1', '2130706433', 'admin_menu', '22', '超级管理员 删除了节点：节点ID(22),节点标题(编辑),节点链接(user/index/edit)', '1', '1558959894');
INSERT INTO `dp_admin_log` VALUES ('85', '32', '1', '2130706433', 'admin_menu', '21', '超级管理员 删除了节点：节点ID(21),节点标题(新增),节点链接(user/index/add)', '1', '1558959899');
INSERT INTO `dp_admin_log` VALUES ('86', '32', '1', '2130706433', 'admin_menu', '20', '超级管理员 删除了节点：节点ID(20),节点标题(用户管理),节点链接(user/index/index)', '1', '1558959905');
INSERT INTO `dp_admin_log` VALUES ('87', '32', '1', '2130706433', 'admin_menu', '19', '超级管理员 删除了节点：节点ID(19),节点标题(权限管理),节点链接()', '1', '1558959910');
INSERT INTO `dp_admin_log` VALUES ('88', '32', '1', '2130706433', 'admin_menu', '68', '超级管理员 删除了节点：节点ID(68),节点标题(用户),节点链接(user/index/index)', '1', '1558959916');
...
CREATE TABLE `dp_admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=255 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';

-- ----------------------------
-- Records of dp_admin_menu
-- ----------------------------
INSERT INTO `dp_admin_menu` VALUES ('1', '0', 'admin', '首页', 'fa fa-fw fa-home', 'module_admin', 'admin/index/index', '_self', '0', '1467617722', '1555816129', '1', '1', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('2', '1', 'admin', '首页', 'fa fa-fw fa-folder-open-o', 'module_admin', 'admin/index/index', '_self', '0', '1467618170', '1557631910', '1', '1', '1', '');
...
INSERT INTO `dp_admin_menu` VALUES ('236', '4', 'admin', '后台用户', 'fa fa-fw fa-user', 'module_admin', '', '_self', '0', '1555844071', '1555844204', '100', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('237', '236', 'admin', '用户管理', 'fa fa-fw fa-user', 'module_admin', 'admin/user/index', '_self', '0', '1555844251', '1555844251', '100', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('238', '236', 'admin', '角色管理', 'fa fa-fw fa-group', 'module_admin', 'admin/role/index', '_self', '0', '1555844752', '1555844752', '100', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('240', '237', 'admin', '权限管理', 'fa fa-fw fa-key', 'module_admin', '', '_self', '0', '1556895955', '1556895955', '1', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('241', '240', 'admin', '新增', '', 'module_admin', 'admin/user/add', '_self', '0', '1556896061', '1556896061', '1', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('242', '240', 'admin', '编辑', '', 'module_admin', 'admin/user/edit', '_self', '0', '1556896129', '1556896129', '2', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('243', '240', 'admin', '删除', '', 'module_admin', 'amdin/user/delete', '_self', '0', '1556896163', '1556896163', '3', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('244', '238', 'admin', '启用', '', 'module_admin', 'admin/role/enable', '_self', '0', '1556896266', '1556896470', '4', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('245', '238', 'admin', '禁用', '', 'module_admin', 'admin/role/disable', '_self', '0', '1556896309', '1556896522', '5', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('246', '238', 'admin', '快速编辑', '', 'module_admin', 'admin/role/quickedit', '_self', '0', '1556896421', '1556896542', '6', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('247', '240', 'admin', '启用', '', 'module_admin', 'admin/user/enable', '_self', '0', '1556896621', '1556896621', '4', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('248', '240', 'admin', '禁用', '', 'module_admin', 'admin/user/disable', '_self', '0', '1556896658', '1556896753', '5', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('249', '240', 'admin', '授权', '', 'module_admin', 'admin/user/access', '_self', '0', '1556896721', '1556896769', '6', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('250', '240', 'admin', '快速编辑', '', 'module_admin', 'admin/user/quickedit', '_self', '0', '1556896812', '1556896812', '7', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('251', '238', 'admin', '新增', '', 'module_admin', 'admin/role/add', '_self', '0', '1556896840', '1556896840', '1', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('252', '238', 'admin', '编辑', '', 'module_admin', 'admin/role/edit', '_self', '0', '1556896864', '1556896864', '2', '0', '1', '');
INSERT INTO `dp_admin_menu` VALUES ('253', '238', 'admin', '删除', '', 'module_admin', 'admin/role/delete', '_self', '0', '1556896892', '1556896892', '3', '0', '1', '');
...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$Brw6wmuSLIIx3Yabid8/Wu5l8VQ9M/H/CG3C9RqN9dUCwZW3ljGOK', '123@q.com', '0', '', '0', '0', '0.00', '0', '1', '0', '0', '1476065410', '1558963542', '1558963542', '2130706433', '100', '1');
